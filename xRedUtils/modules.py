"""
This module provides functions for modules.
...
def get_types_of_module(module: ModuleType, include_imports: bool = False) -> list[type]:
    """
...
def reload_module(path: str, ignore_not_loaded: bool = False) -> ModuleType | None:
    """
